    ...
    <table class="table table-border table-bordered table-bg">
        ...
        @foreach($data as $val)
            <tr class="text-c">
                ...
                <td><a href="javascript:;" onclick="video_play('{{$val -> lesson_name}}','/admin/lesson/play?id={{$val -> id}}','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe6e6;</i> 播放</a></td>
